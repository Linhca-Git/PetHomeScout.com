...
function pethomescout_preview_document_title( $parts ) {
	$path = trim( (string) parse_url( $_SERVER['REQUEST_URI'], PHP_URL_PATH ), '/' );
	$titles = array( 'services-insurance' => 'Get Custom Pet Insurance & Local Care Quotes - PetHomeScout', 'family-home' => 'Pet-Friendly Family Home & Safety Reviews - PetHomeScout', 'smart-tech' => 'Pet Smart Technology & Automated Care Reviews - PetHomeScout', 'cleaning-odor' => 'Pet Stain, Odor & Air Purifier Reviews - PetHomeScout', 'best-robot-vacuum-for-dog-hair' => 'The Best Robot Vacuums for Dog Hair (2026 Reviews) - PetHomeScout', 'robot-vacuums-for-pet-hair' => 'The Best Robot Vacuums for Dog Hair (2026 Reviews) - PetHomeScout', 'tool' => 'Robot Vacuum Matchmaker - PetHomeScout Tools', 'robot-vacuum-selector' => 'Robot Vacuum Matchmaker - PetHomeScout Tools', 'contact' => 'Contact Us - PetHomeScout' );
